---
title: Shuffle
description: Here we have 9 differently colored cubes. The positions of those cubes can be shuffled.
---

<script>
  import ShuffleStory from '$examples/Shuffle.story.svelte'
  import ExampleWrapper from '$routes/docs/_components/ExampleWrapper.svelte'
</script>

Here we have 9 differently colored cubes. The positions of those cubes can be shuffled.
