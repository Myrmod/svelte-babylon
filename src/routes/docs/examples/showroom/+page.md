...
This scene is supposed to show a classic use case. To show something in a room. We have multiple platforms we can navigate to using a menu, which is entirely build using vanilla svelte.
