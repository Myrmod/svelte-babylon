<script lang="ts">
  ...
  export let name: string = 'AxisScaleGizmo'
  ...
  export let parent: BABYLON.ScaleGizmo = undefined
  export let thickness: number = undefined

  export const gizmo = new BABYLON.AxisScaleGizmo(dragAxis, color, gizmoLayer, parent, thickness)
