<script lang="ts">
  ...
  export let name: string = 'Cylinder'
  export let receiveShadows = false
  export let options = {} as Parameters<typeof BABYLON.MeshBuilder.CreateCylinder>[1]
  ...
  const context = createObjectContext(BABYLON.MeshBuilder.CreateCylinder(name, options, root.scene))
