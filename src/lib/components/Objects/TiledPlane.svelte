<script lang="ts">
  ...
  export let options = {} as Parameters<typeof BABYLON.MeshBuilder.CreateTiledPlane>[1]
  ...
  onMount(() => {
    try {
      ...
      root.objects[name] = BABYLON.MeshBuilder.CreateTiledPlane(name, options, root.scene)
