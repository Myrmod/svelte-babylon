<script lang="ts">
  ...
  export let options = {} as Parameters<typeof BABYLON.MeshBuilder.CreateTiledBox>[1]
  ...
  onMount(() => {
    try {
      ...
      root.objects[name] = BABYLON.MeshBuilder.CreateTiledBox(name, options, root.scene)
