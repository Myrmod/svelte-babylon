<script lang="ts">
  ...
  import { CreateTiledPlane } from '@babylonjs/core/Meshes/Builders/tiledPlaneBuilder.js'
  ...
  export let name: string = 'TiledPlane'
  export let receiveShadows = false
  export let options = {} as Parameters<typeof CreateTiledPlane>[1]

  export let parent = getContext<Writable<Mesh>>('object')
  export let object = createReactiveContext('object', CreateTiledPlane(name, options, $scene))
